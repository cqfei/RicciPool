...
cmd_opt.add_argument('-gpu', default='cuda:0', help='cuda:0/1/2/3/4')
...
cmd_opt.add_argument('-number_iterations', type=int, default=5, help='number of iterations for ricci curvature')
